...
public class Command_admininfo extends TFM_Command
{
    ...
    {
        TFM_Util.playerMsg(sender_p, "To Apply go to our forums at http://goldenrealms.boards.net", ChatColor.AQUA);
        TFM_Util.playerMsg(sender_p, "Create a thread in the Super Admin applications forum following the template:", ChatColor.DARK_AQUA);
