...
public class TFM_ServerListener implements Listener
{
    ...
    public void onServerPing(ServerListPingEvent event)
    {
        ...
        String message = String.format("Welcome to JavaFreedom%s! - Fun, Free Op and Looking for someone to host the server Running on Spigot 1.7!", TFM_Util.getPlayerFromIp(ip));
